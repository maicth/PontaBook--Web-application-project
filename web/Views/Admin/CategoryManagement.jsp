...
<html>
    <head>
        ...
        <script>
            function addCate(element){
                var x = document.getElementById("new-cate");
                if(element.checked){
                ...
                function hideForm() {
                    var x = document.getElementById("check-cate");
                    x.checked = false;
                    addCate(x);
    ...
    <body>
        ...
        <div class="pub-container">
            ...
            <span><input id="check-cate" type="checkbox" onclick="addCate(this)"> Thêm danh mục sản phẩm</span>
            <div class="new-cate" id="new-cate" style="display: none">
                <form action="categories" method="post">
                    <table>
                        <tr>
